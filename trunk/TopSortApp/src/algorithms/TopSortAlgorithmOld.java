 ...
 * @author jelena
 */
public class TopSortAlgorithmOld {
...
//      while (there is an object not taken out yet){
            ...
            for (int currentStartPosition = startPOsition; currentStartPosition <= endPossition; currentStartPosition++) {
                ...
                System.out.println("TRENUTNA STARTNA POZICIJA JE:" + currentStartPosition);
                //Take it out of the Bag,
                int element = bag[currentStartPosition];
                System.out.println("ELEMENT JE SADA " + (element + 1));

                bag[currentStartPosition] = bag[startPOsition];
                System.out.println("A bag od iter je posle " + (bag[currentStartPosition] + 1));
                startPOsition++;
...
//         and if it goes to zero, put it in the Bag
                ...
                System.out.println("PRE-Trenutna startna pozicija je , takozvni iter:" + currentStartPosition);
                ...
                bag[currentStartPosition] = element;         //******************zamena starog
                System.out.println("Bag of itera " + currentStartPosition + " je sada" + (element + 1));
    ...
    public void outputOutput(int[] output) {
        try {
            ...
            Logger.getLogger(TopSortAlgorithmOld.class
