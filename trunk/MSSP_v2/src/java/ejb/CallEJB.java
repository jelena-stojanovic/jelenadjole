...
public class CallEJB {
    ...
    private CallEJB() {
        ...
        try {
            ...
            SessionBeanDatasetLocal SBdataset = (SessionBeanDatasetLocal) ctx.lookup("java:global/SPiESSE_v3/EJBSPiES/SessionBeanDataset");
            mapa.put("SBdataset", SBdataset);
            SeassionBeanAdministratorLocal SBadmin = (SeassionBeanAdministratorLocal) ctx.lookup("java:global/SPiESSE_v3/EJBSPiES/SeassionBeanAdministrator");
            mapa.put("SBadmin", SBadmin);
            SessionBeanSimilarityLocal SBSimilarity = (SessionBeanSimilarityLocal) ctx.lookup("java:global/SPiESSE_v3/EJBSPiES/SessionBeanSimilarity");
